    ...
    return (
        <Container fluid className="vh-100 d-flex flex-column">
            <Row className="flex-grow-1">
                {/* Sidebar */}
                <Col md={3} className="p-3" style={{ backgroundColor: '#FFDCB9', color: 'black' }}>
                    <Form>
                        ...
                        <Button variant="light" className="mb-2">Suche speichern</Button>
                        <Button variant="dark" className="mb-3">Suche starten</Button>
